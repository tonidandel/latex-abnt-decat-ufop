...
% Estilo de referencias - biblatex-abnt
...
% ---
% Fonte Baskervaldx - inspirada na lendária fonte Barkerville
\usepackage{Baskervaldx} % tosf in text, tlf in math
\usepackage[baskervaldx,vvarbb]{newtxmath} % math italic letters from Times. 
...
\huge 
{\raggedleft
\includegraphics[scale=0.9]{figuras/abntex2-modelo-img-marca.pdf}\\[1cm]
...
\begin{figure}
\centering
\includegraphics[width=0.6\linewidth]{figuras/basset2.pdf}
...
\footcite{descartes-carta-mersene} para mais informações.
