...
% ---
\titulo{Modelo de trabalho acadêmico (monografia, dissertação, tese) com \LaTeXe + \abnTeX ~para estudantes da Escola de Minas-UFOP, segundo as normas ABNT}
\autor{Estudante}
\local{Ouro Preto}
\data{2022}
...
\preambulo{Trabalho apresentado ao Colegiado do Curso de XXX da Universidade Federal de Ouro Preto como parte dos requisitos para a obtenção do Grau de XXX.}
% ---
	...
	\begin{center}
		\begin{minipage}{1\linewidth}
			...
			\begin{tabular}{ccc}
				\begin{tabular}{c}
					\\
					\includegraphics[width=1cm]{logo-universidade.jpg}
				\end{tabular}
				&
				\begin{tabular}{c}
					\\
				...
				\begin{tabular}{c}
					\\
					\includegraphics[width=2cm]{logo-unidade-2.jpg}
				\end{tabular}
			\end{tabular}
		\end{minipage} \\
\centering
