...
% ---
\titulo{Modelo ABNT (Template) \LaTeX~ para Monografias - Curso de Engenharia de Controle \& Automação - DECAT - UFOP}
...
%
\includepdf[scale=0.7,pages=1,nup=1x1,frame]{folha-de-aprovacao}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[scale=0.3]{fig09} % teste os valores
...
\begin{figure}[htbp]
	\centering
	\includegraphics[scale=0.4]{ichs2} % teste os valores
