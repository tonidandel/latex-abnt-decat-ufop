...
% ---
\titulo{Controle de motores descontrolados}
\autor{João da Silva}
\local{Ouro Preto}
\data{\the\year} % imprime o ano corrente no campo data
\orientador{Prof. Dr. Albert Einstein}
%\coorientador{Profa. Dra. Marie Curie}
	...
	\begin{center}
		\begin{minipage}{\linewidth}
			...
			\begin{tabular}{ccc}
				\begin{tabular}{c}
					\\
					{\raggedleft \includegraphics[width=1.1cm]{logo-universidade.jpg}}
				\end{tabular}
				&
				\begin{tabular}{c}
					\\
				...
				\begin{tabular}{c}
					\\
					{\raggedright \includegraphics[width=2.4cm]{logo-unidade-2.jpg}}
				\end{tabular}
			\end{tabular}
		\end{minipage}
...
%		{\ABNTEXchapterfont \large \imprimirorientadorRotulo \imprimirorientador \\ 
...
\renewcommand{\listfigurename}{Lista de figuras} % altera do antigo ``lista de ilustrações''
...
Se preferir citar apenas o título da obra, pode use o comando \textit{``citetitle''} como, por exemplo \citetitle{lima2025}
...
\begin{table}[]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{lllllll}
			\multicolumn{7}{l}{\textbf{Arquitetura e Urbanismo}}                                                                              \\
			&               &               &                         &                                      &               &  \\
			\multicolumn{7}{l}{\textbf{1º período}}                                                                                           \\
			\textit{\textbf{HORA}} &
			\textit{\textbf{SEGUNDA}} &
			\textit{\textbf{TERÇA}} &
			\textit{\textbf{QUARTA}} &
...
\section*{Um estudo sobre as figuras} % exemplo de ambiente sem numeração

A atual seção é um exemplo de ambiente sem numeração, que se pode conseguir com sufixo ``\*''

Uma figura não mostra nada, ela ilustra. Isto pode ser verificado na figura \ref{fig:308}. Esta figura foi gerada com o ambiente \textit{figure}
\begin{verbatim}
	\begin{figure}[h] % Outras opções: b,t,p,ht,hb..
			\centering
			\includegraphics[width=0.7\textwidth]{fig09.pdf}
			\caption[Escritório de telégrafos.]{Escritório de telegrafia
			do século XIX. Fonte: \textcite{thomson_1869}. 
			Esta é uma legenda completa - não aparece no sumário. 
			Fonte: \textcite{boyle1772}.}
			\label{fig:308}
	\end{figure}
\end{verbatim}
...
\begin{figure}[h] % Outras opções: b (bottom),t (top),p (page) ou alguma combinação entre elas
\centering
\includegraphics[width=0.7\textwidth]{fig09.pdf}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\textwidth]{ichs2.jpg} % teste os valores
